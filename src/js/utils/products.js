...
products.productHTML = (product) => {
  return `
    <li aria-label="${product.name}">
      <a href="product?id=${product.id}" aria-label="See product ${product.name}">
...
products.search = (e) => {
  ...
  window.location.href = `search_product?search=${searchedTerm}`
}
        ...
        <section id="${formattedCategory(category)}" class="category-section" aria-label="${category} products">
          <div class="products-header">
            ...
            ${products.byCategory[category].length > products.maxPerRow
              ? `<a href="category?name=${category}" class="see-all">See all</a>` : ""}
          </div>
      ...
      ${products.list.map(product => `
        <li aria-label="${product.name}">
          <div class="buttons-container" role="none">
            ...
            <a href="edit_product?id=${product.id}" aria-label="Edit ${product.name}">
